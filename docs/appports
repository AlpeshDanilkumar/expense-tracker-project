...
1.  **Port 5000: Flask Application**\
    **Purpose**: This is the default port for the Flask web server running our expense tracker application.\
...
3.  **Port 9090: Prometheus**\
    ...
    **How It Works**: Prometheus scrapes metrics from configured targets (like our Flask app and PostgreSQL exporter) and provides a web interface for querying and viewing these metrics.\
...
This configuration ensures that each component of our system is accessible and communicates effectively with other components and external interfaces.
